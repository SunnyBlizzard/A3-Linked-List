...
My Answer: We have 2 delete calls. One deletes the data stored in our object, the other deletes the data object itself. It's like deleting the stuff inside of a box and then the box too. 
